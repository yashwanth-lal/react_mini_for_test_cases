...
class SearchPage extends Component {
  ...
  componentDidMount = () => {
    this.setState(prevState => ({
      searchRoute: !prevState.searchRoute,
    }))
  }
  ...
  sampleFunc = searchText => this.fetchingFilmsBasedOnSearch(searchText)

  render() {
    const {searchPageStatus, noMovies, searchValue, searchRoute} = this.state
    return (
      <div className="searchPageOuter">
        <Header sampleFunc={this.sampleFunc} searchRoute={searchRoute} />
        {noMovies ? (
