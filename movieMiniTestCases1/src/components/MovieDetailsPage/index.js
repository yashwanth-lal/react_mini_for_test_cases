...
class MovieDetailsPage extends Component {
  state = {selectedMovie: {}, pageStatus: status.loading}
  ...
  //     if (this.fetchMovieWithId) {
  //       this.fetchMovieWithId.cancel()
  //     }
  //   }
  ...
  popularMoviesCaseConverter = movie => {
    ...
    this.setState({pageStatus: status.success, selectedMovie: pascalCaseMovie})
  }
  ...
  deriveYear = releaseDate => new Date(releaseDate).getFullYear()
      ...
      <div className="movieDOuter">
        ...
        <div className="movieDetailsTitlePart">
          ...
          <div className="movieDRuntimeReleaseDate">
            ...
            <p>{this.deriveYear(releaseDate)}</p>
          </div>
